...
//        data: "{}",
        ...
        success: function (result) {			
			...
			for(var r=0; r<result.data.length; r++){
				...
				trHTML += '<td><a href="http://localhost/addcard/edit.html" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a><a data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>';
				trHTML += '</tr>';
			}
